...
router.post('/', passport.authenticate("jwt", { session: false }),
  ...
  const profileFields = {}
    ...
    if (req.body.profile_image) profileFields.profile_image = req.body.profile_image;
...
router.put('/follow',passport.authenticate('jwt',{session:false}),(req,res)=>{
  Profile.findOneAndUpdate({ user: req.body.user_id },{
...
router.get('/follower', passport.authenticate('jwt', { session: false }),async (req, res) => {
  const errors = {};
